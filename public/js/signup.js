...
function validation(){
     ...
     var name=document.getElementById('na').value;         ///dekho yeha id ka use krke sare element le liya hai na client side to yeha mutuat exclusion nhi hoga sbka apna apna hoga 
